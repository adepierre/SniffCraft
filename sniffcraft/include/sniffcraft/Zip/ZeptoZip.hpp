...
public:
    ...
    // File content is compressed using zlib.
    ...
    static void CreateZipArchive(const std::string& outpath, const std::vector<std::string>& inputs, const std::vector<std::string>& filenames);
};
